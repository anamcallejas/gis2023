...
## USEFUL LINK SF: https://r-spatial.github.io/sf/articles/sf1.html
...
# with save():
save(sf.cities, file = 'sf_cities.rdata')

# Exporting it (e.g. shapefile) with st_write():
#TODO!: Sandbox not working
st_write(sf.cities, 'sf_cities.shp')
...
# geometry has low precision! Not recommended!
...
gc <- st_geometrycollection(list(gm.multipoints,gm.line, gm.polyg)) #Plot together a geometry collection
ggplot(gc) +
  geom_sf()
...
# plotting with different projections
ggplot() +
